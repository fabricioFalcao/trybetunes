...
import { SetStateType, SongType } from '../../types';
...
type MusicCardProps = {
  ...
  setUnfavorite?: SetStateType | null
};

function MusicCard({ previewUrl, trackName, trackId, favoriteSongs, setUnfavorite = null }
: MusicCardProps) {
